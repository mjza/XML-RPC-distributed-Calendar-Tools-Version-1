...
public class HostUrl {
	...
	protected HostUrl(int port) {
		super();
		this.setHostUrl("http://127.0.0.1/"); //For sending requests to the current machine
		this.setPort(port != -1 ? port : DefaultPort.portNumber); //Default port for all hostess is 8080.
	}
