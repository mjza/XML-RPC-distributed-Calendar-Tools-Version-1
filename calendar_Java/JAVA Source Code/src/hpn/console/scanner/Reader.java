...
public final class Reader
{
	...
	public static String nextIPv4()
	{
		...
		String	formatErrorMessage = "You have entered wrong IPv4 Address format. Please enter a valid IPv4 Address in the format of this example ["+LocalNet.IpAddress()+"] : ";
		String inputChars= input.nextLine();
