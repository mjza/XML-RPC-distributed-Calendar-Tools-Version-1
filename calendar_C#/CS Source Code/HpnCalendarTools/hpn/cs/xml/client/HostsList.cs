...
namespace hpn.cs.xml.client
{
    public class HostsList : CalendarNetwork
    {
	    ...
	    internal static void initHostList(int port) //it must call locally in the package by hpn.apache.xml.client.HpnXmlRpcClient Contractor function to register local host and initiate the list
	    ...
	    internal static HostUrl getFirstHostUrl()
	    {
